...
# 配置路径
INPUT_DIR = "./evaluation_samples_text-0125V1/input"
GT_DIR = "./evaluation_samples_text-0125V1/output"
OUTPUT_JSON = "./evaluation_samples_text-0125V1/test_set_auto.json"
