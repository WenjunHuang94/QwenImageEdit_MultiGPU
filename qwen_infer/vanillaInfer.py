...
def parse_args():
    ...
    # Paths / Basics
    parser.add_argument("--output_img", type=str, default="raw.png")
    parser.add_argument("--pretrained_model", type=str, default="/storage/v-jinpewang/az_workspace/rico_model/Qwen-Image-Edit-2509")

    # LoRA / Quant
    parser.add_argument("--lora_weight", type=str, default="/storage/v-jinpewang/az_workspace/rico_model/test_lora_saves_edit/checkpoint-2500/pytorch_lora_weights.safetensors")
    ...
    parser.add_argument("--prompt", type=str, default="Please follow the visual instruction on image and return the correctly edited image.")
...
class MultiGPUTransformer():
    """multi GPU decorater, auto dispatch via device_map"""  
