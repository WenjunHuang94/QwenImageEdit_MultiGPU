...
# 配置路径
INPUT_DIR = "./evaluation_samples_vismarker_mixed-0125V2/input"
GT_DIR = "./evaluation_samples_vismarker_mixed-0125V2/output"
OUTPUT_JSON = "./evaluation_samples_vismarker_mixed-0125V2/test_set_auto.json"
