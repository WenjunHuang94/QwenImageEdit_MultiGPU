...
# --- 路径配置 ---
INPUT_DIR="./evaluation_samples_textInImg-0125V1/input"
OUTPUT_BASE="./evaluation_samples_textInImg-0125V1/qwen_base"
OUTPUT_OURS="./evaluation_samples_textInImg-0125V1/ours"
